...
@dso_cache = dso_local local_unnamed_addr global [546 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 438094621, ; hash 0x1a1ccb1d, from name: aot-PlanXFrontend.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2041951840, ; hash 0x79b5b660, from name: libaot-PlanXFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 249
	...
	%struct.DSOCacheEntry {
		i64 2119188670, ; hash 0x7e5040be, from name: aot-PlanXFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 262
	...
	%struct.DSOCacheEntry {
		i64 3234409465, ; hash 0xc0c92bf9, from name: PlanXFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 421
	...
	%struct.DSOCacheEntry {
		i64 3711353089, ; hash 0xdd36c101, from name: PlanXFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 475
	...
	%struct.DSOCacheEntry {
		i64 4107313637, ; hash 0xf4d0a1e5, from name: libaot-PlanXFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 519
