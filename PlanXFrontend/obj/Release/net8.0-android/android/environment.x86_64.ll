...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555209, ; uint32_t android_runtime_jnienv_class_token (0x2000309)
	i32 100671495, ; uint32_t jnienv_initialize_method_token (0x6002007)
	i32 100671494, ; uint32_t jnienv_registerjninatives_method_token (0x6002006)
...
@dso_cache = dso_local local_unnamed_addr global [546 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2304055157641057165, ; hash 0x1ff9a5f55e1a138d, from name: PlanXFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 63
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7639104904330698853, ; hash 0x6a038d6fd0936065, from name: PlanXFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 206
	...
	%struct.DSOCacheEntry {
		i64 12107597237435519067, ; hash 0xa806d389e4d8505b, from name: aot-PlanXFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 352
	...
	%struct.DSOCacheEntry {
		i64 12359538170339688139, ; hash 0xab85e67b76fa7ecb, from name: libaot-PlanXFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 361
	...
	%struct.DSOCacheEntry {
		i64 13088163108438809233, ; hash 0xb5a27f00c8de1a91, from name: aot-PlanXFrontend.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 383
	...
	%struct.DSOCacheEntry {
		i64 17260797955472520663, ; hash 0xef8aac49f3ba75d7, from name: libaot-PlanXFrontend
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlanXFrontend.dll.so
		ptr null; void* handle (0x0)
	}, ; 506
...
@.env.3 = private unnamed_addr constant [37 x i8] c"fdb8e820-c7d5-4bfe-81d0-77e79cd6b095\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [30 x i8] c"com.companyname.planxfrontend\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-PlanXFrontend.dll.so\00", align 16
