...
AS
BEGIN
    SET @ERRORID = 0; -- Inicializa el valor de ERRORID
    ...
    BEGIN
        ...
        IF @@ROWCOUNT = 0 -- Verifica si no se afectaron filas
        BEGIN
            SET @ERRORID = 1;
            SET @ERRORDESCRIPCION = 'ERROR DESDE BD: EL UPDATE NO AFECTÓ NINGUNA FILA';
        END
    END
END
GO